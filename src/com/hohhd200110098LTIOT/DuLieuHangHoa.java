...
public class DuLieuHangHoa {
    ...
    public DanhSachQuanLy danhSach() {
        ...
        HangHoa stt12 = new ThucPham(234, "Thuc Pham", "Banh keo", 20000,"2-03-2021", 300);
        HangHoa stt13 = new DienTu(287, "Dien Tu", "Dien thoai", 10000000,"07- 03-2021", 20);
        HangHoa stt14 = new SanhSu(753, "Sanh Su", "Dia thuy tinh", 50000,"12-03-2021", 50);
        HangHoa stt15 = new ThucPham(752, "Thuc Pham", "Nuoc ngot", 10000, "17-03-2021", 1000);
        HangHoa stt16 = new DienTu(017, "Dien Tu", "May tinh", 35000000, "22-03-2021", 15);
        HangHoa stt17 = new SanhSu(259, "Sanh Su", "Ly thuy tinh",  35000, "27-03-2021", 100);
        HangHoa stt18 = new ThucPham(769, "Thuc Pham", "Gia vi", 20000,"01-04-2021", 150);
        HangHoa stt19 = new DienTu(112, "Dien Tu", "Tai nghe", 650000, "6-04-2021", 35);
        HangHoa stt20 = new SanhSu(045, "Sanh Su", "Binh gom trang tri", 75000, "11-04-2021", 25);
